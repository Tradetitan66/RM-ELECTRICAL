    ...
    <section className="bg-ink text-white" aria-labelledby="hero-heading">
      <div className="container-site py-14 sm:py-16 lg:py-24">
        <div className="max-w-3xl">
          <p className="mb-5 inline-flex w-fit items-center border border-white/20 px-3 py-1 text-xs font-semibold tracking-[0.18em] text-white/75">
            ALEXANDRIA &bull; BALLOCH &bull; SURROUNDING AREAS
          </p>

          <h1
            id="hero-heading"
            className="text-[clamp(2.5rem,7vw,5rem)] font-extrabold uppercase leading-[0.95]"
          >
            Electrical work.
            <br />
          ...
          <ul className="mt-8 flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:gap-x-8">
